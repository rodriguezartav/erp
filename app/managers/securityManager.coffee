...
class SecurityManager
  ...
  constructor: ->
    ...
    @profiles["Tesoreria"] = [ AprobarNota , PedidosAprobacionGerencia , PedidosAprobacionEspecial ,  FacturasProveedor , PagosProveedor , DocumentosAnular ,  CuentasPorPagarEntrega , NotaCreditoProveedor , VerRegistrosResumen , VerRegistros ]
