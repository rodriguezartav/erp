...
class CuentaPorPagar extends Spine.Model
  ...
  "NombreProveedor" , "FlagedToSave" , "Tipo_de_Documento" , "FechaIngreso","Estado" , "CategoriaGasto"
  ...
  @queryFilter: (options ) =>
    ...
    filter = @queryFilterAddCondition(" Estado__c IN ('Para Pagar','Calendarizado') and (FechaPagoProgramado__c <= TODAY or Tipo_de_Documento__c ='NC') " ,  filter)  if options.paraPagar
